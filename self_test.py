...
os.environ["USE_FAKE_MODE"] = "1"
os.environ["REDIS_URL"] = "redis://localhost:6379/15"       # dedicated test DB
os.environ["POSTGRES_DSN"] = "postgresql://postgres:postgres@localhost:5432/memory_rag"
...
def cleanup():
    ...
    try:
        with connection.cursor() as cursor:
            cursor.execute("TRUNCATE long_term_memory, semantic_memory, knowledge_base")
        connection.commit()
    finally:
